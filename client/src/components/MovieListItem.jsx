...
const MovieListItem = ({ item }) => {
  ...
  return (
    <div className="movieListItem relative w-40 mr-2 hover:scale-125 hover:z-[999] rounded-md">
      <Link to="/watch" className="movieListItemDetails flex flex-col justify-end opacity-0 top-40 absolute h-full w-full z-[10]" state={{ movie: movie }}>
      </Link>
